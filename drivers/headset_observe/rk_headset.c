...
#if defined(CONFIG_SND_RK_SOC_RK2928) || defined(CONFIG_SND_RK29_SOC_RK610) || defined(CONFIG_SND_RK29_SOC_RK610_PHONEPAD)
...
{
	if(headset_info->pdata->Sw_mic_gpio == INVALID_GPIO)
		return;
	if(value == HP_MIC)
