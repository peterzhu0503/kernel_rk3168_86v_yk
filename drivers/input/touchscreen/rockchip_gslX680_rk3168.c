...
#if defined(CONFIG_TOUCHSCREEN_GSLX680_3680_DEYI)
	#include "rockchip_gsl3680_deyi.h"
#elif defined(CONFIG_TOUCHSCREEN_GSLX680_3680_9INCH_DEYI)
	#include "rockchip_gsl3680_9inch_deyi.h" 
#elif defined(CONFIG_TOUCHSCREEN_GSLX680_1680_SHX)
	#include "rockchip_gsl1680_shx.h"
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_9INCH_108_1024x600)
	#include "rockchip_gslX3680_9inch_108_1024x600.h"
#elif defined(CONFIG_TOUCHSCREEN_GSLX680_8INCH_800X600)
	#include "rockchip_gslX3680_8inch_800x600.h"
#elif defined(CONFIG_TOUCHSCREEN_GSLX680_8INCH_1024X600)
	#include "rockchip_gslX3680_8inch_1024x600.h"
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_800x480_LEHENG)
...
#elif defined(CONFIG_TOUCHSCREEN_GSL1680_7INCH_HRA771)
	#include "rockchip_gslX680_7inch_rha771.h"
#elif defined(CONFIG_TOUCHSCREEN_GSLX680_9INCH_800X480_TengYao)
	#include "rockchip_gslX680_9inch_800x480_TengYao.h"
#elif defined(CONFIG_TOUCHSCREEN_GSLX680_9INCH_1024X600)
	#include "rockchip_gslX680_9inch_1024x600.h"
#elif defined(CONFIG_TOUCHSCREEN_GSLX680_9INCH_800X480)
...
#define print_info(fmt, args...)
	...
	static int revert_x = 1;
	static int revert_y = 1;
#elif defined(CONFIG_MACH_RK3168_86V)
	static int revert_xy = 1;
	static int revert_x = 1;
	static int revert_y = 0;
#else
