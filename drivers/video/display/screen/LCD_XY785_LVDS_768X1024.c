...
#define H_PW			10
#define H_BP			80//100
#define H_VD			768//1280
#define H_FP			80//18

#define V_PW			10////2
#define V_BP			23//8
#define V_VD			1024//800
#define V_FP			18//6

#define LCD_WIDTH          	120//216
#define LCD_HEIGHT         	160//135
/* Other */
#if defined(CONFIG_RK610_LVDS) || defined(CONFIG_RK616_LVDS)  
#define DCLK_POL	1
#else
...
/*
*********1080P 60HZ*********
pll_cfg_val:0x01842013
frac:0x677f23
dsp_frm_vst:0x00f
dsp_frm_hst:0x316
*/
#define S_PLL_CFG_VAL		0x01842013//0x01842016
#define S_FRAC			0x677f23//0xc16c2d
#define S_SCL_VST		0x00f//0x25
#define S_SCL_HST		0x316//0x4ba
...
/*
*********1080P 50HZ*********
pll_cfg_val:0x01443014
frac:0x367989
dsp_frm_vst:0x00f
dsp_frm_hst:0x3b4
*/

#define S1_PLL_CFG_VAL		0x01443014//0x01c42016
#define S1_FRAC			0x367989//0x1f9ad4
#define S1_SCL_VST		0x00f//0x25
#define S1_SCL_HST		0x3b4//0x5ab
...
#define S2_PLL_CFG_VAL		0x01822013//0x01822016
#define S2_FRAC			0x677f23//0xc16c2d
#define S2_SCL_VST		0x00a//0x19
#define S2_SCL_HST		0x5d7//0x483
...
/*
*********720P 50HZ*********
pll_cfg_val:0x01423014
frac:0x367989
dsp_frm_vst:0x00a
dsp_frm_hst:0x702
*/
#define S3_PLL_CFG_VAL		0x01423014//0x01c22016
#define S3_FRAC			0x367989//0x1f9ad4
#define S3_SCL_VST		0x00a//0x19
#define S3_SCL_HST		0x702//0x569
...
/*
*********576P 50HZ*********
pll_cfg_val:0x01412013
frac:0x4ce7b4
dsp_frm_vst:0x022
dsp_frm_hst:0x06b
*/
#define S4_PLL_CFG_VAL		0x01412013//0x01412016
#define S4_FRAC			0x4ce7b4//0xa23d09
#define S4_SCL_VST		0x022//0x2d
#define S4_SCL_HST		0x06b//0x33d
...
/*
*********480P 60HZ*********
pll_cfg_val:0x01412017
frac:0x528c72
dsp_frm_vst:0x01c
dsp_frm_hst:0x324
*/
#define S5_PLL_CFG_VAL		0x01412017//0x01c11013
#define S5_FRAC			0x528c72//0x25325e
#define S5_SCL_VST		0x01c//0x26
#define S5_SCL_HST		0x324//0x2ae
