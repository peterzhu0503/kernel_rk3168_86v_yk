...
enum{
    ...
    SCALE_PLL(148500000,    32062500,   19, 11,  8),
    ...
    SCALE_PLL(74250000,    32062500,   38, 11, 8),
    ...
    SCALE_PLL(27000000,     33750000,   20, 2,  8),
    SCALE_PLL(27000000,     31640625,   75, 8,  8),
    SCALE_PLL(27000000,     39375000,   35, 3,  8),
};
